...
function getValue() {
	var leimu = $(".listclick:eq(0)").children("i:eq(1)").html();
	var leixing = $(".listclick:eq(1)").html();
	//	var goods=
...
function addGoods() {
	$("#goods").append("<div  class='spxx'>" +
		...
		"<span class='upimg'><input type='file' id='file' class='file'/><img src='#' title='上传图片'></span>" +
		"<span>" +
		"<ul id='leixing'>" +
		"<li>商品类别" +
		"<select>" +
